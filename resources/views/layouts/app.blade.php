            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <a href="/auth_login.php" class="nav-link text-body font-weight-bold px-0" target="_blank">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/default.html " target="_blank">
                ...
                <span class="ms-1 font-weight-bold">LTREA</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">GENERAL PAGES</h6>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#authExamples" class="nav-link " aria-controls="authExamples" role="button" aria-expanded="false">
                        ...
                        <span class="nav-link-text ms-1">Autorisasi</span>
                    </a>
                        ...
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item ">
                                <a class="nav-link " href="#">
                                    ...
                                    <span class="sidenav-normal"> Perizinan Pengguna </span>
                                </a>
                                <a class="nav-link " href="#">
                                    <span class="sidenav-mini-icon"> PP </span>
                                    <span class="sidenav-normal"> Pengaturan Role </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="pagesExamples">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <!-- <li class="nav-item ">
                            <a class="nav-link" data-bs-toggle="collapse" aria-expanded="true" href="#signinExample">
                                <span class="sidenav-mini-icon"> S </span>
                                <span class="sidenav-normal"> Daftar Gedung <b class="caret"></b></span>
                            </a>
                            <div class="collapse show" id="signinExample" style="">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pengesahan_ijazah" class="nav-link " aria-controls="pengesahan_ijazah" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Pengesahan Ijazah</span>
                    </a>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#tenan_kantin" class="nav-link " aria-controls="tenan_kantin" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Tenan Kantin</span>
                    </a>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#penyewaan_kendaraan" class="nav-link " aria-controls="penyewaan_kendaraan" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Penyewaan Kendaraan</span>
                    </a>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#studio_foto" class="nav-link " aria-controls="studio_foto" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Studio Foto</span>
                    </a>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#master_gedung" class="nav-link " aria-controls="master_gedung" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#master_ijazah" class="nav-link " aria-controls="master_ijazah" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Data Ijazah</span>
                    </a>
                    <div class="collapse " id="master_ijazah">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#">
                                    <span class="sidenav-mini-icon"> TG </span>
                                    <span class="sidenav-normal"> Table Ijazah </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#master_tenan" class="nav-link " aria-controls="master_tenan" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#master_pmobil" class="nav-link " aria-controls="master_pmobil" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Penyewaan Mobil</span>
                    </a>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#master_studio" class="nav-link " aria-controls="master_studio" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="collapse " id="master_studio">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#">
                                    <span class="sidenav-mini-icon"> TM </span>
                                    <span class="sidenav-normal"> Table Studio </span>
                                </a>
                            </li>
                        </ul>
                    </div>

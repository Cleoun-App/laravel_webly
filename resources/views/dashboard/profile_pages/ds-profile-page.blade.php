            ...
            <div class="col-lg-5 col-sm-8">
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1 @if($page == 'profile_page') active @endif " href="{{ route('profilePage') }}" >
                                <div class="icon me-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1 @if($page == 'change_password_page') active @endif" href="{{ route('changePasswordPage') }}" >
                                <div class="icon me-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1 @if($page == 'profile_config_page') active @endif"  href="{{ route('profileConfigPage') }}">
                                <div class="icon me-2">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-sm-auto col-4">
                            <div class="avatar avatar-xl position-relative">
                                <img src="{{ $user->getPP() }}" alt="bruce" class="w-100 border-radius-lg shadow-sm">
                            </div>
                        </div>
               ...
               @if ($page == 'profile_page')
                <div class="card mt-4" id="basic-info">
                        ...
                        <form class="card-body pt-0" method="POST">
                            @csrf
                            @method('POST')
                            <input type="hidden" name="key" value="{{ \Crypt::encryptString($user->id) }}">
                            <div class="row">
                                <div class="col-6">
                                    <label class="form-label">Nama lenkap</label>
                                    <div class="input-group">
                                        <input name="nama_lenkap" class="form-control" type="text" placeholder="Alec" required="required" value="{{ $user->name }}">
                                    </div>
                                    @error('nama_lenkap')
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input name="nama_pengguna" class="form-control" type="text" placeholder="Thompson" required="required" value="{{ $user->username }}">
                                    </div>
                                    @error('nama_pengguna')
                                        <span style="color:#ff3131; font-size: 13px;">{{$message}}</span>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input name="email" class="form-control" type="email" placeholder="example@email.com" value="{{ $user->email }}">
                                    </div>
                                    @error('email')
                                        <span style="color:#ff3131; font-size: 13px;">{{$message}}</span>
                                    @enderror
                                ...
                                <div class="col-6">
                                    <label class="form-label mt-4">Nomor telpon</label>
                                    <div class="input-group">
                                        <input name="nomor_telp" class="form-control" type="text" value="{{ $user->nomor_telp }}">
                                    </div>
                                    @error('nomor_telp')
                                        <span style="color:#ff3131; font-size: 13px;">{{$message}}</span>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label class="form-label mt-4">Alamat KTP</label>
                                    <div class="input-group">
                                        <input id="location" name="alamat_ktp" class="form-control" type="text" value="{{ $user->alamat_ktp }}">
                                        @error('alamat_ktp')
                                            <span style="color:#ff3131; font-size: 13px;">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6">
                                    <label class="form-label mt-4">Alamat Tinggal</label>
                                    <div class="input-group">
                                        <input id="location" name="alamat_sekarang" class="form-control" type="text" value="{{ $user->alamat_sekarang }}">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <label class="form-label mt-4">Kota</label>
                                    <div class="input-group">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        <input id="zip" name="zip_code" class="form-control" type="text" value="{{ $user->zip }}">
                                    </div>
                                    @error('zip_code')
                                        <span style="color:#ff3131; font-size: 13px;">{{$message}}</span>
                                    @enderror
                            ...
                            <button type="submit" class="btn bg-gradient-dark btn-sm float-end mt-3 mb-0">Update Informasi</button>
                        </form>
                    </div>
               @endif
                ...
                @if ($page == 'change_password_page')
                    <form method="POST" class="card mt-4" id="password">
                        @csrf
                        @method('POST')
                        <div class="card-header">
                            <h5>Ubah password</h5>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <h5 class="mt-5">Kriteria Password</h5>
                            <p class="text-muted mb-2">
                                Harap penuhi lankah berikut, jika password anda ingin kuat:
                            </p>
                            <ul class="text-muted ps-4 mb-0 float-start">
                                <li>
                                    <span class="text-sm">1 spesial karakter harus ada dalam password</span>
                                </li>
                                <li>
                                    <span class="text-sm">Minimal karakter 6</span>
                                </li>
                                <li>
                                    <span class="text-sm">Di dalam password terdapat 1 -> 2 karakter anka</span>
                                </li>
                                <li>
                                    <span class="text-sm">Lakukan perubahan secara rutin</span>
                                </li>
                            </ul>
